...
<body>
    ...
    <table>
        ...
        <tr>
            <td align="center"><button class="button" onmousedown="toggleCheckbox('clip_open');"
                    ontouchstart="toggleCheckbox('clip_open');" onmouseup="toggleCheckbox('stop');"
                    ontouchend="toggleCheckbox('stop');">Clip Open</button></td>
            <td></td>
            <td align="center"><button class="button" onmousedown="toggleCheckbox('clip_close');"
                    ontouchstart="toggleCheckbox('clip_close');" onmouseup="toggleCheckbox('stop');"
                    ontouchend="toggleCheckbox('stop');">Clip Close</button></td>
        </tr>        
        <tr>
